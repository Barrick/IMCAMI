...
if (isset($_SESSION['username'])) {
    header("index/Login/menu/indexAdmin.php");
}
...
if (isset($_POST['submit'])) {
	...
	if ($result->num_rows > 0) {
		...
		header("Location: menu/indexAdmin.php");
	} else {
...
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			<p class="login-text" style="font-size: 2rem; font-weight: 800;">Login Administrador</p>
