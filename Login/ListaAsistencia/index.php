...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/home1nuevo.css">
      ...
      <section>
          <div class="container">
            ...
            <div class="table-responsive resultadoFiltro">
              ...
              <?php
              include('config.php');
              $sqlTrabajadores = ('SELECT * FROM asistencia ORDER BY fecha DESC');
...
$("#filtro").on("click", function(e){ 
  ...
  if(f_ingreso !="" && f_fin !=""){
    ...
    $("#loaderFiltro").html('<p style="color:red;  font-weight:bold;">Se debe seleccionar una fecha</p>');
  }
} );
